...
// const HOST_NAME = "http://13.60.195.100:8080"
const HOST_NAME = import.meta.env.VITE_PARKPLUS_BACKEND_DNS_AWS
const LISTING_SEARCH_API = "/api/v1/listings/search";
const LISTING_BY_ID = "/api/v1/listings"
const BOOKING_PREVIEW_API = "/api/v1/bookings/preview"
const BOOKING_CREATE_API = "/api/v1/bookings"
const BOOKING_HISTORY_API = "/api/v1/bookings/history"
const CREATE_ORDER_API = "/api/v1/payments/create-order"
...
export const LISTING_SEARCH_URL = `${HOST_NAME}${LISTING_SEARCH_API}`;
export const LISTING_BY_ID_URL = `${HOST_NAME}${LISTING_BY_ID}`;
export const BOOKING_PREVIEW_URL = `${HOST_NAME}${BOOKING_PREVIEW_API}`;
export const BOOKING_CREATE_URL = `${HOST_NAME}${BOOKING_CREATE_API}`;
export const BOOKING_HISTORY_URL = `${HOST_NAME}${BOOKING_HISTORY_API}`;
export const CREATE_ORDER_URL = `${HOST_NAME}${CREATE_ORDER_API}`;
